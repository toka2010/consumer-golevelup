...
export declare type MessageErrorHandler = (channel: Channel, msg: ConsumeMessage, error: any) => Promise<void> | void;
/**
...
export declare type AssertQueueErrorHandler = (channel: Channel, queueName: string, queueOptions: QueueOptions | undefined, error: any) => Promise<string> | string;
/**
